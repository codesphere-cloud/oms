...
// NewMockDockerfileManager creates a new instance of MockDockerfileManager. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockDockerfileManager(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockDockerfileManager {
	mock := &MockDockerfileManager{}
	mock.Mock.Test(t)
...
func (_m *MockDockerfileManager) EXPECT() *MockDockerfileManager_Expecter {
	return &MockDockerfileManager_Expecter{mock: &_m.Mock}
}
