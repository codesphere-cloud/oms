...
// GetOmsRegistry provides a mock function for the type MockEnv
func (_mock *MockEnv) GetOmsRegistry() string {
	ret := _mock.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetOmsRegistry")
	}
...
// MockEnv_GetOmsRegistry_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetOmsRegistry'
type MockEnv_GetOmsRegistry_Call struct {
	*mock.Call
}

// GetOmsRegistry is a helper method to define mock.On call
func (_e *MockEnv_Expecter) GetOmsRegistry() *MockEnv_GetOmsRegistry_Call {
	return &MockEnv_GetOmsRegistry_Call{Call: _e.mock.On("GetOmsRegistry")}
}

func (_c *MockEnv_GetOmsRegistry_Call) Run(run func()) *MockEnv_GetOmsRegistry_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *MockEnv_GetOmsRegistry_Call) Return(s string) *MockEnv_GetOmsRegistry_Call {
	_c.Call.Return(s)
	return _c
}

func (_c *MockEnv_GetOmsRegistry_Call) RunAndReturn(run func() string) *MockEnv_GetOmsRegistry_Call {
	_c.Call.Return(run)
	return _c
}
