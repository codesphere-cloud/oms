...
var _ = Describe("Bom", func() {
	...
	Describe("CodesphereImageReferences", func() {
		It("returns sorted unique Codesphere refs from typed BOM fields", func() {
			cfg := &bom.Config{
			...
			Expect(cfg.ImageReferencesForCodesphereRegistry()).To(Equal([]string{
