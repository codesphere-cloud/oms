...
// NewMockArgoCDManager creates a new instance of MockArgoCDManager. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockArgoCDManager(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockArgoCDManager {
	mock := &MockArgoCDManager{}
	mock.Mock.Test(t)
...
// MockArgoCDManager is an autogenerated mock type for the ArgoCDManager type
type MockArgoCDManager struct {
	mock.Mock
}

type MockArgoCDManager_Expecter struct {
	mock *mock.Mock
}

func (_m *MockArgoCDManager) EXPECT() *MockArgoCDManager_Expecter {
	return &MockArgoCDManager_Expecter{mock: &_m.Mock}
}

// Install provides a mock function for the type MockArgoCDManager
func (_mock *MockArgoCDManager) Install() error {
	ret := _mock.Called()
...
// MockArgoCDManager_Install_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Install'
type MockArgoCDManager_Install_Call struct {
	*mock.Call
}

// Install is a helper method to define mock.On call
func (_e *MockArgoCDManager_Expecter) Install() *MockArgoCDManager_Install_Call {
	return &MockArgoCDManager_Install_Call{Call: _e.mock.On("Install")}
}

func (_c *MockArgoCDManager_Install_Call) Run(run func()) *MockArgoCDManager_Install_Call {
...
func (_c *MockArgoCDManager_Install_Call) Return(err error) *MockArgoCDManager_Install_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockArgoCDManager_Install_Call) RunAndReturn(run func() error) *MockArgoCDManager_Install_Call {
	_c.Call.Return(run)
	return _c
}
