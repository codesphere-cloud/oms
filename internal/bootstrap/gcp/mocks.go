...
// StoreSecret provides a mock function for the type MockGCPClientManager
func (_mock *MockGCPClientManager) StoreSecret(projectID string, key string, value []byte) error {
	ret := _mock.Called(projectID, key, value)
	...
	if returnFunc, ok := ret.Get(0).(func(string, string, []byte) error); ok {
		r0 = returnFunc(projectID, key, value)
	} else {
		r0 = ret.Error(0)
	}
	return r0
...
// MockGCPClientManager_StoreSecret_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'StoreSecret'
type MockGCPClientManager_StoreSecret_Call struct {
	*mock.Call
}
...
//   - key string
//   - value []byte
func (_e *MockGCPClientManager_Expecter) StoreSecret(projectID interface{}, key interface{}, value interface{}) *MockGCPClientManager_StoreSecret_Call {
	return &MockGCPClientManager_StoreSecret_Call{Call: _e.mock.On("StoreSecret", projectID, key, value)}
}

func (_c *MockGCPClientManager_StoreSecret_Call) Run(run func(projectID string, key string, value []byte)) *MockGCPClientManager_StoreSecret_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *MockGCPClientManager_StoreSecret_Call) Return(err error) *MockGCPClientManager_StoreSecret_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockGCPClientManager_StoreSecret_Call) RunAndReturn(run func(projectID string, key string, value []byte) error) *MockGCPClientManager_StoreSecret_Call {
	_c.Call.Return(run)
	return _c
}
